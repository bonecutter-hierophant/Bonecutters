...
- `client:static`: checks `client/index.html` and public asset references without invoking Vite.
...
- Client HTML or public asset changes while iterating: `npm run verify:scoped dependency-layout,public-sanitization,client:static,docs`
